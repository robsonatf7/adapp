...
/**
 * This is an Android Service to provide REST functionality outside of the
 * Application thread.
 */
public class RestService {
	...
	// Workaround to add HTTP Basic auth
	...
	public void execute() {
		...
		intent.putParcelableArrayListExtra("headers",
				(ArrayList<? extends Parcelable>) headers);
