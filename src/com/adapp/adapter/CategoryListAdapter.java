...
public class CategoryListAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.textViewName = (TextView) convertView.findViewById(R.id.category_row_category_name);
			holder.textViewTotal = (TextView) convertView.findViewById(R.id.category_row_ads_amount);
